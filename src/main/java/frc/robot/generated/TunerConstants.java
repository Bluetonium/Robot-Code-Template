...
public class TunerConstants {
        ...
        public static class TunerSwerveDrivetrain extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
                /**
                 * Constructs a CTRE SwerveDrivetrain using the specified
                 * constants.
                 * <p>
                 * This constructs the underlying hardware devices, so users
                 * should not construct the devices themselves. If they need the
                 * devices, they can access them through getters in the classes.
                 *
                 * @param drivetrainConstants Drivetrain-wide constants for the
                 * swerve drive
                 ...
                 * @param drivetrainConstants Drivetrain-wide constants for the
                 * swerve drive
                 * @param odometryUpdateFrequency The frequency to run the
                 * odometry loop. If unspecified or set to 0 Hz, this is 250 Hz
                 ...
                 * odometry loop. If unspecified or set to 0 Hz, this is 250 Hz
                 * on CAN FD, and 100 Hz on CAN 2.0.
                 * @param odometryStandardDeviation The standard deviation for
                 * odometry calculation in the form [x, y, theta]áµ€, with units
                 * in meters and radians
                 * @param visionStandardDeviation The standard deviation for
                 * vision calculation in the form [x, y, theta]áµ€, with units
                 * in meters and radians
                 * @param modules Constants for each specific module
                 */
                public TunerSwerveDrivetrain(SwerveDrivetrainConstants drivetrainConstants,
        ...
        // When not Pro-licensed, Fused*/Sync* automatically fall back to
        // Remote*
        private static final SteerFeedbackType kSteerFeedbackType = SteerFeedbackType.FusedCANcoder;

        private static final Current kSlipCurrent = Amps.of(120);
        // Initial configs for the drive and steer motors and the azimuth
        // encoder; these
        // cannot be null.
        ...
        /**
         * Creates a CommandSwerveDrivetrain instance. This should only be
         * called once in your robot program,.
         */
