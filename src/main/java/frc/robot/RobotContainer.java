...
public class RobotContainer {
    public static double MaxSpeed = 1 * TunerConstants.kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts desired
                                                                                            // top speed
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain.applyRequest(() -> drive.withVelocityX(-chassisController.getLeftY() * MaxSpeed) // Drive
                                                                                                            // forward
                                                                                                            // with
                                                                                                            // negative
                                                                                                            // Y
                        ...
                        .withRotationalRate(-chassisController.getRightX() * MaxAngularRate) // Drive counterclockwise
